...
public class HttpResponse implements Response {
  ...
  public final String PRERENDER_URL = "prerender.url";
  ...
  public HttpResponse(HttpBase http, URL url, WebPage page)
    ...
    String prerenderUrl = this.conf.get(PRERENDER_URL);

    if (!StringUtils.isBlank(prerenderUrl)) {
      url = new URL(prerenderUrl+url.toString());
    }
