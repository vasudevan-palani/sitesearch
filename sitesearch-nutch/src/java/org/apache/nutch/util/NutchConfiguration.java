...
public class NutchConfiguration {
  ...
  public static final Logger LOG = LoggerFactory.getLogger(NutchConfiguration.class);
   ...
   * overrides.
   */
  public static Configuration create(String crawlId) {
    Configuration conf = new Configuration();
    setUUID(conf);
    addNutchResources(conf);
    addWebsiteResources(conf,crawlId);
    return conf;
  }
  ...
  private static Configuration addNutchResources(Configuration conf) {
    LOG.info("Loading nutch-site.xml -- vasu");
   ...
   *          Configuration object to which configuration is to be added.
   */
  private static Configuration addWebsiteResources(Configuration conf,String crawlId) {
    LOG.info("Loading /home/hadoop/sitesearch-conf/nutch-site.xml,"+crawlId);
    conf.addResource(new Path("/home/hadoop/sitesearch-conf/nutch-site.xml"));
    conf.addResource(new Path("/home/hadoop/websites/"+crawlId+"/nutch-site.xml"));
    return conf;
  }
}
